...
locals {
  ...
  pipeline_files_directory_path = "${path.module}/pipelines"
  pipeline_template_files_directory_path = "${path.module}/pipeline/templates"

  pipeline_files = fileset("${local.pipeline_files_directory_path}/pipelines", "*.yaml")
  pipeline_template_files = fileset("${local.pipeline_template_files_directory_path}/pipeline/templates", "**/*.yaml")
