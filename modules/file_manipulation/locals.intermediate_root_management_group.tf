locals {
  ...
  terraform_intermediate_root_management_group = local.is_terraform_iac_type ? ({ for management_group in local.terraform_architecture.management_groups : management_group.id => management_group if management_group.parent_id == null })[0] : null
